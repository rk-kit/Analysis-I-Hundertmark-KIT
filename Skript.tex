...
\begin{document}
    ...
    \begin{satz}[Leibnitz-Kriterium] % Satz 11
        ...
        \begin{proof}
            ...
            \begin{align*}
                ...
                &\geq s_{2n}
                \intertext{$\impl (s_{2n})_n$ ist monoton wachsend}
                s_{2(n+1)+1} &= s_{2n+3}\\
                &= \sum_{j=1}^{2n+3} (-1)^{j+1} \cdot a_j\\
                &= s_{2n+1} + (-1)^{(2n+2)+1} \cdot a_{2n+2} + (-1)^{(2n+3)+1} \cdot a_{2n+3}\\
                &= s_{2n+1} - a_{2n+2} + a_{2n+3}\\
                &\leq s_{2n+1}
                \intertext{$\impl (s_{2n+1})_n$ ist monoton fallend und}
                s_{2n+1} - s_{2n} &= \sum_{j=1}^{2n+1} (-1)^{j-1} \cdot a_j - \sum_{j=1}^{2n} (-1)^{j+1} a_j\\
                &= (-1)^{(2n+1)+1} \cdot a_{2n+1} = a_{2n+1} \geq 0
                \intertext{$\impl \abs{s_{2n+1}-s_{2n}} = a_{2n+1}\fromto 0$ konvergieren und $s_{2n+1} \geq s_{2n}$}
                0 \leq a_{1} ???\\
                ...
                \text{und } s_g &= s_u\\
                \impl (s_n)_n\text{ konvergiert gegen $s=s_g=s_u$}
            \end{align*}
        \end{proof}
        \begin{uebung}
    ...
    \begin{beispiel}
        \begin{align*}
            &\sum_{n=1}^{\infty} \pair{-1}^{n+1} \cdot \frac{1}{\sqrt{1}}\text{ konvergiert}\\
            \text{aber } &\sum_{n=1}^{\infty} \frac{1}{\sqrt {n}} \text{ divergiret}\\
    ...
    \begin{satz}[Cauchy-Kriterium] % Satz 12
        ...
        \begin{proof}
            \begin{align*}
                ...
                \intertext{$(s_n)_n$ konvergiert genau dann, wenn es eine Cauchy-Folge ist. Das heißt}
                \forall\varepsilon > 0~\exists N_{\varepsilon}\in\naturalnumbers\colon &\abs{\sum_{j=n+1}^{m} a_j} = \abs{s_{m} - s_{n}} < \varepsilon\quad\forall m> n \geq N_{\varepsilon}\\
                s_m - s_n &= \sum_{j=1}^{m} a_j = \sum_{j=1}^{n} a_j\\
    ...
    \begin{korollar} % Korollar 12
        ...
        \begin{proof}
            Satz 12 $\impl$
            \begin{align*}
                \forall \varepsilon > 0~\exists N_{\varepsilon}\in\naturalnumbers\colon \abs{\sum_{j=n+1}^{n+p} a_j} < \varepsilon\quad\forall n\geq N_2, p\in\naturalnumbers\\
                \intertext{Wähle $p=1$}
    ...
    \begin{definition}[Absolute Konvergenz] % Definition 1
        ...
        \begin{align*}
            \sum_{j=1}^{\infty} \abs{a_j}
        \end{align*}
        konvergiert. Das heißt falls
        \begin{align*}
            \sum_{n=1}^{\infty} \abs{n} < \infty
        \end{align*}
    \end{definition}
    ...
    \begin{satz} % Satz 2
        ...
        \begin{align*}
            \sum_{n}^{\infty} a_n
        \end{align*}
        absolut konvergent, so ist sie auch konvergent und
        \begin{align*}
        ...
        \begin{proof}
            ...
            \end{align*}
            Nehmen an: $\sum_{n=1}^{\infty} \abs{a_n}$ konvergiert. Das heißt Cauchy ist erfüllt.
            \begin{align*}
                \impl \forall \varepsilon > 0~\exists N_{\varepsilon}\colon \sum_{j=n+1}^{\infty} \abs{a_j} < \varepsilon \quad\forall m> n\geq N_{\varepsilon}\\
    ...
    \begin{definition}[Majorante] % Def 3
        Die Reihe
        \begin{align*}
            \sum_{n=1}^{\infty} c_n~c_n\geq 0~\forall n\in\naturalnumbers
        \end{align*}
        ist eine Majorante der Reihe $\sum_{n}^{\infty} a_n$ falls
        \begin{align*}
            \abs{a_n} &\leq c_n\text{ für fast alle }n\in\naturalnumbers
            \intertext{Das heißt}
            \exists n_0\in\naturalnumbers\colon \abs{a_n} < \varepsilon_{n_0}\quad\forall n\geq n_0
        \end{align*}
    \end{definition}
    ...
    \begin{satz}[Majoranten-Konvergenz-Kriterium für Reihen] % Satz 4
        ...
        \begin{align*}
            \sum_{n=1}^{\infty} a_n
        \end{align*}
        eine konvergente Majorante $\sum_{n=1}^{\infty} c_n$, so ist die Reihe selber absolut konvergent und somit auch konvergent.
        \begin{proof}
            Folgt aus Satz 2 und Satz 11 $(c_n\geq 0 \& \sum_{n}^{\infty} c_n\text{ konvergiert}\impl \sum_{n=1}^{\infty} c_n < \infty)$
        \end{proof}
    \end{satz}
    ...
    \begin{satz}[Quotientenkriterium] % Satz 5
        ...
        \begin{proof}
            Haben $n_0\in\naturalnumbers$
            \begin{align*}
                \frac{\abs{a_{n+1}}}{\abs{a_n}} \leq q\quad\forall n\geq n_0
                \intertext{$p\in\naturalnumbers$, $n=n_0+p$}
                \abs{a_{n+1}} \leq q\cdot\abs{a_n} \leq q^2 \cdot \abs{a_{n-1}} \leq q^3 \cdot \abs{a_{n-2}}\\
                \leq \dots \leq q^{p+1} \cdot\abs{a_{n_0}} = q^{n-n_0} \cdot\abs{a_{n_0}}\\
                = q^{n} \cdot q^{-n_0} \cdot\abs{a_{n_0}}\\
                \leadsto \abs{a_n} \leq \underbrace{q^n \cdot K}_{\definedas c_n}\\
                K = q^{-n_0} \cdot \abs{a_{n_0}}\\
                \abs{a_{n_0}} \leq c_n\quad\forall n\geq n_0\\
                \intertext{und}
                \sum_{n+c}^{\infty} c_n &= \sum_{n+c}^{\infty} K\cdot q^{n} = K\cdot \sum_{n+c}^{\infty} q^{n} < \infty
                \intertext{Da $0< q < 1$}
                \impl \sum_{n=c}^{\infty} a_n\text{ hat die konvergente Majorante } K \cdot \sum_{n=c}^{\infty} q^{n}
                \intertext{Das lässt sich aus Satz 4 folgern}
            \end{align*}
            \begin{align*}
                \text{Ist } \liminf_{n\fromto\infty} \frac{\abs{a_{n+1}}}{\abs{a_n}} > 1\\
                \impl \forall \varepsilon > 0~\exists n_0\colon \frac{\abs{a_{n+1}}}{\abs{a_n}} \geq \overline{q} - \varepsilon = \frac{\overline{q}+1}{2} \geq q > 1
                \intertext{Wählen $\varepsilon=\frac{\overline{q}-1}{2} > 0$}
                \impl \frac{\abs{a_n+1}}{\abs{a_n}} \geq q > 1\quad\forall n\geq n_0\\
                \impl \abs{a_{n+1}} \geq q^{n+1} \cdot q^{n_0}\cdot\abs{a_{n_0}}\\
                \impl \abs{a_n} \geq q^n\cdot K\\
                K = q^{?}\cdot \abs{q_{n_0}} \fromto\infty\\
                \impl \sum_{}^{} a_j\text{ divergiert nach Korollar 13 in Kapitel 11}
            \end{align*}
        \end{proof}
    \end{satz}
    ...
    \begin{bemerkung}
        \begin{align*}
            ?? \equivalent \limsup_{n\fromto\infty} \frac{\abs{a_{n+1}}}{\abs{a_n}} < 1\\
            \text{Ist } \limsup_{n\fromto\infty} \frac{\abs{a_{n+1}}}{\abs{a_n}} > 1\impl \sum_{n=0}^{\infty} a_0\text{ divergent}\\
            \text{Ist } \limsup_{n\fromto\infty} \frac{\abs{a_{n+1}}}{\abs{a_n}} = 1\impl \text{Keine Aussage über absolute Konvergenz von } \sum_{n=0}^{\infty} a_n\text{ möglich}
        \end{align*}
    \end{bemerkung}
    ...
    \begin{beispiel}
        \begin{align*}
            a_n &= \frac{1}{n}\\
            \frac{\abs{a_{n+1}}}{\abs{a_n}} = \frac{a_{n+1}}{a_n} = \frac{n}{n+1}
            \intertext{und}
    ...
    \begin{beispiel}
        ...
        \end{align*}
        aber $\sum a_p$ konvergiert absolut.
        \begin{align*}
            \pair{1-\frac{1}{n}}^2 = 1 - \frac{2}{n+1}+ \pair{\frac{1}{n+1}}^2\\
            = 1 - \frac{2}{n+1}\cdot\pair{1-\frac{1}{??}} \leq 1- \frac{?}{?}
        \end{align*}
        ???
    \end{beispiel}
    ...
    \begin{beispiel}
        ...
        \begin{align*}
            ...
            e &= \lim_{\ntoinfty} \pair{1+\frac{1}{n}}^n = \sum_{k=0}^{n}\binom{n}{k} \pair{\frac{1}{n}}^k\\
            &= \sum_{k=0}^{n} \frac{n\cdot(n-1)\cdot(n-k+1)}{k!\cdot n^k}\\
            &= \sum_{k=0}^{n} \frac{1}{k!} \cdot \prod_{j=0}^{k-1} \frac{n-j}{n}\\
            &\leq \sum_{k=0}^{n} \frac{1}{k!} = \sum_{k=0}^{\infty} \frac{1}{k!}\\
