...
\begin{document}
    ...
    \begin{definition}[Konvexität/Konkavität]
        ...
        \begin{align*}
            f\of{\lambda x + \pair{1-\lambda}\cdot y} \underset{\text{bzw. } \geq}{\leq} \lambda f(x) + \pair{1-\lambda}\cdot f(y)
        \end{align*}
    \end{definition}
    ...
    \begin{lemma} % Lemma 2
        ...
        \begin{proof}[Beweis (i)]
            ...
            \begin{align*}
                ...
                \impl \pair{g\circ f}\of{\lambda x + \pair{1-\lambda}\cdot y} &\leq \pair{g\circ f}\of{x} + \pair{1-\lambda}\cdot\pair{g\circ f}\of{y}\qedhere
            \end{align*}
        \end{proof}
