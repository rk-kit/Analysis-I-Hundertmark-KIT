...
\begin{document}
        ...
        \begin{proof}
            ...
            \begin{enumerate}[label=(\roman*)]
                ...
                \begin{align*}
                    ...
                    \intertext{$A$ ist nach unten beschränkt und ach Satz~\ref{satz:von-archimedes} gilt $A\neq \emptyset$. Nach Satz~\ref{satz:wohlordnungsprinzip} erweitert auf $\mathbb{Z}$ folgt}
    ...
    \begin{beispiel}[Geometrische Folge und Reihe]\footnote{Wir setzen $0^0 = 1$}
        \begin{align*}
        ...
        \end{align*}
        Dass dieser Zusammenhang gelten muss, lässt sich einfach veranschaulichen. Die linke Seite der Gleichung kann als Summe über Teilflächen des Einheitsquadrats\footnote{Original: \anf{Kuchen}} visualisiert werden.\\
        Es wird eine Hälfte, dann ein Viertel, dann ein Achtel (usw.) des Quadrats hinzugefügt. Der zurückbleibende Flächeninhalt ist immer genauso groß wie das zuletzt hinzugefügte Stück. Dieser Term wird durch den rechten Teil der Gleichung beschrieben.
