...
\begin{document}
    ...
    \begin{satz} % Satz 5
        ...
        \begin{proof}
            \anf{$\impl$}: Folgt direkt aus Lemma~\ref{lemma:konv-cauchy}\\
            \anf{$\Leftarrow$}: Sei $(a_n)$ eine Cauchy-Folge $\annot{\impl}{Lemma~\ref{lemma:beschr-cauchy}} (a_n)_n$ ist beschränkt $\annot{\impl}{Satz~\ref{satz:bolzano-weierstrass}} a_n$ hat eine konvergente Teilfolge $\annot{\impl}{Lem 4} a_n$ konvergent
        \end{proof}
    \end{satz}
    ...
    Frage: Gegeben eine reelle Folge $a_n$. Was ist $a_1 + a_2 + a_3 + \dots = \sum_{n=1}^{\infty} a_n$
    ...
    \begin{definition}[]
        ...
        a) Es steht für die Folge der Partialsummen $s_n\definedas \sum_{j=1}^{n} a_j\quad\forall n\in\naturalnumbers$\\
        b) Die Reihe $\sum_{n=1}^{\infty} a_n$ konvergent, falls der Grenzwert der Partialsummen $\lim_{n\fromto\infty} s_n$ existiert.\\
        Setzen
        \begin{align*}
            \sum_{n=1}^{\infty} a_n \definedas \lim_{n\fromto\infty} s_n
        \end{align*}
        Wert der Reihe $\sum_{n=1}^{\infty} a_n$\\
        c) Konvergiert $s_n$ nicht, so heißt $\sum_{n=1}^{\infty} a_n$ divergent.\\
        Falls $s_n$ bestimmt divergiert so setzen wir
        \begin{align*}
    ...
    \begin{satz}[Monotone Konvergenz für Reihen] % Satz 2
        ...
        \begin{proof}
            Beachte $s_{n+1} = \sum_{j=1}^{n+1} a_j = \sum_{j=1}^n a_j + a_{n+1} \geq \sum_{j=1}^{n} a_j = s_n$ und wende Satz~\ref{satz:monoton-konv} an.
        \end{proof}
    \end{satz}
    ...
    \begin{bemerkung}
        ...
        \begin{align*}
            ...
            \sum_{n=0}^{\infty} a_n &\definedas \lim s_n\text{ sofern der Limes existiert}\\
