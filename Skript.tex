...
\begin{document}
    ...
    \begin{beispiel}
        ...
        \begin{align*}
            ...
            \impl e^{ax} \lim_{h\fromto 0} \frac{1+ah+(ah)^2\cdot e}{h} = a\cdot e^{ax}\tag{$a\in\C$}
        \end{align*}
    \end{beispiel}
    ...
    \begin{satz}[Der Taylorsche Satz] % Satz 12
        ...
        \begin{align*}
            P_{n-1}(t) &= \sum_{k=0}^{n-1} \frac{f^{(k)}\of{\alpha}}{k!}\cdot\pair{t-\alpha}^k
    ...
    \begin{notation}[Taylor-Polynom]
        Alternative Schreibweise:
        \begin{align*}
            P_{n-1}\of{t} &= T_n\of{f,\alpha}
        \end{align*}
    \end{notation}
    ...
    \begin{bemerkung}[Über Max und Min]
        ...
        \begin{proof}
            \begin{align*}
                ...
                \impl \ex\varepsilon > 0\colon \frac{f'\of{\xi} - f'\of{x_0}}{\xi-x_0} > 0\quad\forall\xi, 0 < \abs{x-\xi} < \varepsilon
                \impl \begin{cases}
                          f'\of{\xi} < 0,~\xi < x_0, 0 < \abs{\xi-x_0} < \varepsilon\\
                          f'\of{\xi} > 0,~\xi > x_0, 0 < \abs{\xi-x_0} < \varepsilon
                \end{cases}
            \end{align*}
