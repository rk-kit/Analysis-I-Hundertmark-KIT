...
\begin{document}
    ...
    \begin{definition} % Definition 1
        ...
        \begin{align*}
            f'_+ &= \lim_{h\fromto 0_+} \frac{f(x+h)-f(x)}{h}
    ...
    \begin{satz} % Satz 2
        ...
        \end{align*}
        \begin{proof}
            \anf{$\impl$}: Sei $f$ differenzierbar. $\varphi \definedas f(x)-f(a) - f'(a)\cdot\pair{x-a}$. Also $C=f'\of{a}$.
            \begin{align*}
                \frac{\varphi\of{x}}{x-a} &= \underbrace{\frac{f(x)-f(a)}{x-a}}_{\fromto f'(a)} - f'(a) \fromto 0
            \end{align*}
            \anf{$\Leftarrow$}: Es gilt $f(x) = f(a)+C\cdot\pair{x-a} + \varphi\of{x}, \frac{\varphi(x)}{x-a}\fromto 0$ für $x\fromto a$
            \begin{align*}
    ...
    \begin{korollar}
        ...
        \label{korollar:18-2}
        \begin{enumerate}[label=(\roman*)]
            \item $f$ ist differenzierbar $\impl f$ ist stetig im Punkt $a$. ($x\fromto a, f(x)-f(a) = C\cdot\pair{x-a} + \frac{\varphi(x)}{x-a}\cdot\pair{x-a}\fromto 0$)
    ...
    \begin{satz} % Satz 3
        ...
        \begin{proof}[Beweis (iii)]
            \begin{align*}
                ...
                &= \lim_{h\fromto 0} f(x+h)\cdot \underbrace{\frac{g(x+h)-g(x)}{h}}_{\fromto g'(x)} + \lim_{h\fromto 0} g(x) \cdot \underbrace{\frac{f(x+h)-f(x)}{h}}_{\fromto f'(x)} = f(x) \cdot g'(x) + g(x)f'(x)
            \end{align*}
        \end{proof}
    \end{satz}
    ...
    \begin{satz}[Kettenregel] % Satz 4
        Seien $f: \pair{a,b}\fromto \R$ und $g: (c,d)\fromto \R$ die Funktionen mit $f(a,b) \sbset \pair{c,d}$. Funktion $f$ sei im Punkt $x$ differenzierbar und $g$ sei im Punkt $y\definedas f(x)$ differenzierbar. Dann gilt $\pair{g\circ f}'(x) = g'(f(x)) \cdot f'(x)$.
        \begin{proof}
            $F(x) \definedas g(f(x))$
            \begin{align*}
                \lim_{\substack{h\fromto 0\\ h\neq 0}} \frac{F(x+h)-F(x)}{h}
    ...
    \begin{beispiel}
        ...
        \begin{align*}
            \pair{e^{ax}}' &= \lim_{h\fromto 0} \frac{e^{a(x+h)} - e^{ax}}{h} = \lim_{h\fromto 0}\frac{e^{ax}-1}{h} = e^{ah} \lim_{h\fromto 0} \frac{e^{ah}-1}{h}\\
